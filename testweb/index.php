                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="slider-right-text">
                                    ...
                                    <p>PolyUber is a ridesharing app for fast, reliable rides in minutes.<br>With PolyUber, you just tap to request a ride.<br>Login and request your ride now!</p>
                                </div>
                            </div>
                        </div>
                    </div>
